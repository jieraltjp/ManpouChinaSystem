package com.manpou.notification.infrastructure.aspect;

import com.manpou.notification.common.annotation.Idempotent;
...
public class IdempotencyAspect {
    ...
    private Object deserializeAndReturn(String redisKey, String cached, ProceedingJoinPoint pjp) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to deserialize cached result: " + redisKey, ex);
        }
    }
