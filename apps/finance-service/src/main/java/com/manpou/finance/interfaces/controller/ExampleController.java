package com.manpou.finance.interfaces.controller;

import com.manpou.finance.application.dto.ExampleCreateCmd;
import com.manpou.finance.application.dto.ExamplePageQuery;
import com.manpou.finance.application.dto.ExampleQuery;
import com.manpou.finance.application.dto.ExampleUpdateCmd;
import com.manpou.finance.application.usecase.ExampleUseCase;
import com.manpou.finance.common.annotation.Idempotent;
...
public class ExampleController {
    ...
    public Result<Void> update(@PathVariable Long id,
        ...
        log.info("[AUDIT] {} updated id={}", "finance", id);
    ...
    public Result<Void> delete(@PathVariable Long id) {
        ...
        log.info("[AUDIT] {} deleted id={}", "finance", id);
