...
--
-- 修复: INSERT japan_customs:update (ID=92)，INSERT IGNORE 幂等
--
-- ID=92：V15 baseline 最大 ID=91（role:delete），V17 用于 user_avatar_mediumtext，故跳至 V19。
-- 注意：原本 V17 错误写成 ID=70，与 factory:create (ID=70) 冲突，已更正为 92。
...
VALUES (92, 'japan_customs:update', '编辑日本清关', '日本通関を編集', 'japan_customs', 'UPDATE', 92, 1, NOW(3), 0, 'SYSTEM', 'SYSTEM');
