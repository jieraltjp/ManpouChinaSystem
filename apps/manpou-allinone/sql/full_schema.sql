...
DROP TABLE IF EXISTS `cn_hs_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `consolidation_pool`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `demand_procurement_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `domestic_customs_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `japan_customs_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `jp_hs_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `procurement_snapshot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `replenishment_demand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `shipment_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `tax_refund_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `v_order_chain_v1`;
/*!50001 DROP VIEW IF EXISTS `v_order_chain_v1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_order_chain_v1` (
...
/*!50001 DROP TABLE IF EXISTS `v_order_chain_v1`*/;
/*!50001 DROP VIEW IF EXISTS `v_order_chain_v1`*/;
...
/*!50001 VIEW `v_order_chain_v1` AS select `d`.`id` AS `demand_id`,`d`.`demand_code` AS `demand_code`,`d`.`demand_type` AS `demand_type`,`d`.`product_code` AS `demand_product_code`,`d`.`sub_product_code` AS `demand_sub_product_code`,`d`.`quantity` AS `demand_quantity`,`d`.`destination` AS `demand_destination`,`d`.`japan_lead` AS `demand_japan_lead`,`d`.`status` AS `demand_status`,`d`.`linked_procurement_id` AS `linked_procurement_id`,`d`.`image_url` AS `demand_image_url`,`d`.`create_time` AS `demand_create_time`,`d`.`update_time` AS `demand_update_time`,`p`.`id` AS `procurement_id`,concat('P-',cast(`p`.`id` as char charset cp932)) AS `procurement_code`,`p`.`factory_id` AS `procurement_factory_id`,`p`.`product_code` AS `procurement_product_code`,`p`.`sub_product_code` AS `procurement_sub_product_code`,`p`.`quantity` AS `procurement_quantity`,`p`.`price_rmb` AS `procurement_price_rmb`,`p`.`tax_point` AS `procurement_tax_point`,`p`.`exchange_rate` AS `procurement_exchange_rate`,`p`.`billing_type` AS `procurement_billing_type`,`p`.`estimated_price_jpy` AS `procurement_estimated_price_jpy`,`p`.`order_date` AS `procurement_order_date`,`p`.`factory_ship_date` AS `procurement_factory_ship_date`,`p`.`planned_ship_date` AS `procurement_planned_ship_date`,`p`.`actual_ship_date` AS `procurement_actual_ship_date`,`p`.`lead_time_days` AS `procurement_lead_time_days`,`p`.`product_lead` AS `procurement_product_lead`,`p`.`japan_lead` AS `procurement_japan_lead`,`p`.`china_lead` AS `procurement_china_lead`,`p`.`destination` AS `procurement_destination`,`p`.`customer_company` AS `procurement_customer_company`,`p`.`status` AS `procurement_status`,`p`.`create_time` AS `procurement_create_time`,`sn`.`factory_id` AS `snapshot_factory_id`,`sn`.`factory_code` AS `snapshot_factory_code`,`sn`.`factory_name` AS `snapshot_factory_name`,`sn`.`factory_province` AS `snapshot_factory_province`,`sn`.`factory_city` AS `snapshot_factory_city`,`sn`.`factory_contact_name` AS `snapshot_factory_contact_name`,`sn`.`factory_contact_phone` AS `snapshot_factory_contact_phone`,`sn`.`product_name_zh` AS `snapshot_product_name_zh`,`sn`.`product_name_ja` AS `snapshot_product_name_ja`,`sn`.`product_category` AS `snapshot_product_category`,`q`.`id` AS `qc_record_id`,`q`.`qc_code` AS `qc_code`,`q`.`result` AS `qc_result`,`q`.`inspection_count` AS `qc_inspection_count`,`q`.`passed_count` AS `qc_passed_count`,`q`.`defective_count` AS `qc_defective_count`,`q`.`box_count` AS `qc_box_count`,`q`.`box_length_cm` AS `qc_box_length_cm`,`q`.`box_width_cm` AS `qc_box_width_cm`,`q`.`box_height_cm` AS `qc_box_height_cm`,`q`.`net_weight_per_unit` AS `qc_net_weight_per_unit`,`q`.`gross_weight` AS `qc_gross_weight`,`q`.`qc_date` AS `qc_date`,`q`.`status` AS `qc_status`,`q`.`create_time` AS `qc_create_time`,`l`.`id` AS `logistics_plan_id`,`l`.`plan_code` AS `logistics_plan_code`,`l`.`container_no` AS `logistics_container_no`,`l`.`plan_type` AS `logistics_plan_type`,`l`.`cargo_length_cm` AS `logistics_cargo_length_cm`,`l`.`cargo_width_cm` AS `logistics_cargo_width_cm`,`l`.`cargo_height_cm` AS `logistics_cargo_height_cm`,`l`.`cargo_volume_cbm` AS `logistics_cargo_volume_cbm`,`l`.`cargo_weight_kg` AS `logistics_cargo_weight_kg`,`l`.`requires_qc` AS `logistics_requires_qc`,`l`.`estimated_ship_date` AS `logistics_estimated_ship_date`,`l`.`actual_ship_date` AS `logistics_actual_ship_date`,`l`.`status` AS `logistics_status`,`l`.`create_time` AS `logistics_create_time`,(case when (`d`.`id` is not null) then 'COMPLETED' else 'NOT_STARTED' end) AS `step1_status`,(case when (`p`.`id` is not null) then 'COMPLETED' else 'NOT_STARTED' end) AS `step2_status`,(case when (`q`.`id` is not null) then 'COMPLETED' else 'NOT_STARTED' end) AS `step3_status`,(case when (`l`.`id` is not null) then 'COMPLETED' else 'NOT_STARTED' end) AS `step4_status`,NULL AS `step5_status`,NULL AS `step6_status`,NULL AS `step7_status`,NULL AS `step8_status`,NULL AS `domestic_customs_id`,NULL AS `domestic_customs_no`,NULL AS `domestic_hs_code`,NULL AS `domestic_declaration_date`,NULL AS `domestic_export_port`,NULL AS `domestic_declared_value_rmb`,NULL AS `domestic_customs_status`,NULL AS `domestic_create_time`,NULL AS `japan_customs_id`,NULL AS `japan_customs_entry_no`,NULL AS `japan_arrival_date`,NULL AS `japan_customs_broker`,NULL AS `japan_broker_phone`,NULL AS `japan_import_duty_paid`,NULL AS `japan_consumption_tax_paid`,NULL AS `japan_clearance_date`,NULL AS `japan_customs_status`,NULL AS `japan_create_time`,NULL AS `tax_refund_id`,NULL AS `tax_refund_amount`,NULL AS `tax_refund_date`,NULL AS `tax_refund_status`,NULL AS `tax_refund_create_time`,NULL AS `sales_record_id`,NULL AS `sales_record_code`,NULL AS `sales_channel`,NULL AS `sales_listing_date`,NULL AS `sales_initial_stock`,NULL AS `sales_current_stock`,NULL AS `sales_safety_stock`,NULL AS `sales_sales_quantity`,NULL AS `sales_returned_quantity`,NULL AS `sales_return_rate`,NULL AS `sales_selling_price_jpy`,NULL AS `sales_status`,NULL AS `sales_create_time` from ((((`replenishment_demand` `d` left join `procurement` `p` on(((`p`.`id` = `d`.`linked_procurement_id`) and (`p`.`is_deleted` = 0x00)))) left join `procurement_snapshot` `sn` on((`sn`.`procurement_id` = `p`.`id`))) left join `qc_record` `q` on(((`q`.`procurement_id` = `p`.`id`) and (`q`.`is_deleted` = 0x00)))) left join `logistics_plan` `l` on(((`l`.`qc_record_id` = `q`.`id`) and (`l`.`is_deleted` = 0x00)))) where (`d`.`is_deleted` = 0x00) */;
