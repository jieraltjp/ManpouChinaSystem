-- ============================================================
-- ManpouChinaSystem — 生产环境数据库初始化脚本
-- 来源: mysqldump 当前数据库 (192.168.13.202:23306/manpou)
-- 生成: 2026-05-11
-- Flyway 基线: V1..V14 已应用，V15..V48 由 JPA ddl-auto 创建（表已存在）
-- 用途: Flyway baseline + V49 缺失迁移
-- ============================================================
