...
const filterForm = ref({ status: '' as ContainerStatus | '', containerNo: '' })
const dialogVisible = ref(false)
const dialogTitle = ref('')
const editingItem = ref<Partial<ContainerVO>>({})

const formData = ref({ containerNo: '', containerType: 'GP20' as ContainerType, loadDate: '', departureDate: '', arrivalDate: '' })
...
function onReset() { filterForm.value = { status: '', containerNo: '' }; pagination.value.page = 0; loadData() }

function onNew() {
  editingItem.value = {}
  dialogTitle.value = t('logistics.container.newButton')
  formData.value = { containerNo: '', containerType: 'GP20', loadDate: '', departureDate: '', arrivalDate: '' }
