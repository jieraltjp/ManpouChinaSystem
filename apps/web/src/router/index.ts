      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { titleKey: 'menu.cargoSize', requiresAuth: true, permission: 'page:cargo_size:access' },
          },
          {
            path: 'legacy-procurement',
            name: 'LegacyProcurement',
            component: () => import('@/pages/legacy-procurement/LegacyProcurementPage.vue'),
            meta: { titleKey: 'menu.legacyProcurement', requiresAuth: true, permission: 'page:legacy_procurement:access' },
          },
          {
            path: 'dispatch',
            name: 'Dispatch',
            component: () => import('@/pages/base/DispatchPage.vue'),
            meta: { titleKey: 'menu.dispatch', requiresAuth: true, permission: 'page:dispatch:access' },
          },
          {
            path: 'offline-order',
            name: 'OfflineOrder',
            component: () => import('@/pages/offline-order/OfflineOrderPage.vue'),
            meta: { titleKey: 'menu.offlineOrder', requiresAuth: true, permission: 'page:offline_order:access' },
          },
        ],
      },
      {
