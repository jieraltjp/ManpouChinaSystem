...
> **版本**: 1.3.0
> **更新**: 2026-05-25（新增 SPEC-B17 日志与错误追踪系统 Phase 1/2/3 完成）
...
| B-17 | [SPEC-B17-日志与错误追踪系统.md](./SPEC-B17-日志与错误追踪系统.md) | Phase 1/2/3 ✅：ErrorCode 28个 + logback ERROR_FILE + 前端 logger + 审计扩展 |
...
| B-11 | B-11 用户中心与权限体系 | UI-17~20 | V15/V18/V19 |
| B-12 | B-12 货柜与船只管理 | UI-19（container v2.0）+ UI-21（ship） | DB-14 ship+container 扩展 |
| B-13 | B-13 直接采购功能设计 | UI-02（ProcurementPage 扩展） | procurement 表扩展 procurement_type + demand_id |
