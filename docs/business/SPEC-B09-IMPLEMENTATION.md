...
> **版本**: 1.5.1
> **创建**: 2026-04-22
> **更新**: 2026-05-13（v1.5.1：文档审计修正；footer 版本同步为 1.5.1；Phase 2 标记移除）
> **状态**: 🟢 已完成
...
5. 新增 `ReplenishmentDemandRepository.findByLinkedProcurementIdAndDeletedIsFalse()`
