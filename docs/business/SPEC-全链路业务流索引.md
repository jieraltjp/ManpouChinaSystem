...
**对应文档**: `SPEC-发注管理流程.md` §3.1 · `DOMAIN-发注管理领域模型.md` §1.1
...
**对应文档**: `SPEC-发注管理流程.md` §3.2 · `DOMAIN-发注管理领域模型.md` §1.2 §1.3
...
**对应文档**: `SPEC-发注管理流程.md` §3.3 · `DOMAIN-发注管理领域模型.md` §1.5
...
**对应文档**: `SPEC-发注管理流程.md` §3.4 · `SPEC-调配计划流程.md` · `DOMAIN-发注管理领域模型.md` §1.6
...
| 现有文档 | 覆盖范围 | 缺失内容 |
|---------|---------|---------|
| SPEC-发注管理流程.md | 步骤1-6 字段清单 | 步骤7-8，循环反馈，商品数据库 |
| DOMAIN-发注管理领域模型.md | 聚合根定义 | 步骤5-8 具体字段，退税/运营实体 |
| SPEC-调配计划流程.md | 步骤4 详细设计 | Container 字段，出发港/目的港 |
| SPEC-验货记录流程.md | 步骤3 状态机 | sellerName 来源，qcUserId 联动 |
