...
*相关文档：[docs/ui/ARCHITECTURE.md §8](../ui/ARCHITECTURE.md#8-element-plus-表格布局规范) · [docs/lessons/Lombok-Decoupling-DI-Lessons.md#Lesson-46](../lessons/Lombok-Decoupling-DI-Lessons.md#lesson-46-element-plus-el-card--el-table-布局须防-deep-污染禁止覆盖内部结构宽度)*
