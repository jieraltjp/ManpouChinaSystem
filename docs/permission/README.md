...
| 文件 | 内容 |
|------|------|
| [PERMISSION-CODE-ALIGNMENT.md](./PERMISSION-CODE-ALIGNMENT.md) | 权限代码文档对齐审计：DB 83条 vs ALL_PERMISSIONS Set 71条差异分析 |
...
- DB: `permission` 表 83 条（V15基线78 + V18 ship 4 + V19 japan_customs:update 1）
